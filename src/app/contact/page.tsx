...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch to discuss AI engineering opportunities, collaborations, or just to connect.",
};
      ...
      <div className="mx-auto max-w-5xl px-6 py-20">
        ...
        <div className="mx-auto mt-16 max-w-2xl text-center">
          <p className="text-sm text-foreground-muted">
            Based in your timezone-friendly location. Happy to chat async via
            email or schedule a call to discuss opportunities.
          </p>
        </div>
      </div>
    </div>
